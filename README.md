...
`Next.js` • `Laravel` • `Flutter` • `React.js` • `REST API`

### 💻 Programming Languages

`PHP` • `JavaScript` • `TypeScript` • `Dart` • `HTML` • `CSS`

### 🗄️ Databases & Backend Services

`MySQL` • `Firebase` • `Supabase` • `Database Design` • `API Integration`

### 🎨 Design & Tools

`Figma` • `Git` • `GitHub` • `VS Code` • `Postman` • `Android Studio` • `StarUML`

---

## 📊 System Analysis & Database Skills
...
💡 I enjoy turning complex business requirements into scalable software solutions while combining system analysis, database engineering, and modern application development.
